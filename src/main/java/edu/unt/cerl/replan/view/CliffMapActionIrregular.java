 ...
 * @version $Id$
 */
public class CliffMapActionIrregular extends MapAction {
     ...
     */
    public CliffMapActionIrregular(MapPane mapPane) {
        this(mapPane, false);
    }
     ...
     */
    public CliffMapActionIrregular(MapPane mapPane, boolean showToolName) {
        String toolName = showToolName ? CliffMapToolIrregular.TOOL_NAME : null;
        super.init(mapPane, toolName, CliffMapToolIrregular.TOOL_TIP, CliffMapToolIrregular.ICON_IMAGE);
    }
